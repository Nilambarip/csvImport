...
if (isset($_POST["import"])) { $csvImportService->importCSV($_FILES); }
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="container">
            <div class="outer-container">
                <div class="row">
                    <div class="input-row">
                        <form class="form-horizontal" action="" method="post" name="CSVImportForm" id="CSVImportForm" enctype="multipart/form-data">
                            ...
                            <?php
                            $result = $csvImportService->getUsers();
                            if (!empty($result)) {
                            ?>
                                <table id='userTable'>
                                    <thead>
